...
<body style="background-color: white;">
    <div class="container-xxl bg-white p-0">
        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
            <a href="homeadmin.html" class="navbar-brand d-flex align-items-center text-center py-0 px-4 px-lg-5">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <h1 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Productos agotados</h1>
                <div class="row g-4 mb-4">
                    <div class="col-md-12 fadeInUp mb-5" data-wow-delay="0.1s">
                        <?php
                            $conexion = new conexion();
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            ...
                                            <button type="button" class="btn btn-warning" onclick="showModalContent('<?php echo $campo['id_pro']; ?>')">Agregar productos</button>&nbsp;
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <!-- Modal para agregar productos en inventario -->
        <div class="modal fade" id="staticBackdrop2" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <form method="post">
                        <div class="modal-header" style="background-color: #A3D489; color: black;">
                          <h4 class="modal-title" id="staticBackdropLabel">Agregar producto</h4>
                          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body text-center">
                            <div id="conte-modal2"></div>
                        </div>
                        <div class="modal-footer" style="background-color: #A3D489;">
                          <button type="button" class="btn btn-warning" data-bs-dismiss="modal">Cerrar</button>
                          <input type="submit" name="agregar" id="agregar" class="btn btn-warning" value="Guardar cambios">
                        </div>
                    </form>
                    <?php
                       if (isset($_POST['agregar'])) {
                        ...
                        $query=$conexion->prepare('UPDATE productos SET stock = :st_ock WHERE id_pro = :id_proo');

                        $query->bindParam(':id_proo',$idpro);
                        $query->bindParam(':st_ock',$new);
                        $query->execute();
                        ...
                        ?><script>
                          Swal.fire({
                              icon: 'warning',
                              title: 'Ocurrió un error al editar el producto, vuelvalo a intentar',
                              showConfirmButton: true,
                              timer: 2500
                            }).then(function(){
                                window.location="homeadmin.php"
    ...
    <script type="text/javascript">
        ...
        function showModalContent(dataValue){
            $('#conte-modal2').load('edit_modal.php?matri=' + dataValue, function() {
