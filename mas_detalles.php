                    ...
                    <div class="col-md-6">
                        <div class="wow fadeInUp" data-wow-delay="0.5s">
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="pass" name="pass" value="<?php echo $campo['stock']; ?>" readonly>
                                        <label for="pass">Num. de productos en inventario:</label>
                                    </div>
                                </div>
                                <div class="col-12 text-center">
                                    <a href="homeadmin.php" class="btn btn-outline-success w-60" type="submit" id="guardar" name="guardar">Regresar</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row g-4">
			                ...
			                <div class="row g-4">
			                    ...
			                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
			                        <div class="d-flex mb-3">
			                            ...
			                            <button class="btn btn-primary" href="mas_detalles.php">Más detalles</button>
			                        </div>
			                    </div>
			                </div>
			            </div>
			        ...
			        <?php }}
                        ...
                        echo '<h4 class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">Aún no hay productos para mostrar</h4>';
                        ?><center><div class="col-md-6"><img src="img/triste.png" width="20%"></div></center><?php
                    }?>
			    	</div>
			    </div>
			</div>
