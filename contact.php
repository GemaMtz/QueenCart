                        ...
                        <div class=" fadeInUp" data-wow-delay="0.5s">
                            <form action="" method="post" enctype="multipart/form-data">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <input type="text" class="form-control" id="tele_fono" name="tele_fono" value="<?php echo $campo['tel_fono']; ?>" autofocus>
                                    ...
                                    <div class="col-12 invoiceBox">
                                      ...
                                      <input id="file" multiple="" name="imagen" id="image" size="16000" type="file" accept="image/x-png,image/gif,image/jpeg,image/jpg" onchange="verifysize()">
                                    </div>
            ...
            if (isset($_POST['guardar'])) {
                ...
                if(!empty($_POST['file']))
                {
                    ...
                    ?><script>
                      Swal.fire({
                          icon: 'warning',
                          title: 'Debe de completar los campos del formulario',
                          showConfirmButton: true,
                          timer: 2500
                        });
                    </script><?php
    ...
    <script type="text/javascript">
        ...
        function verifysize() {
            ...
            if (inputFile.files.length > 0) {
                ...
                var maxSize = 1 * 1024 * 1024; // Tamaño máximo permitido (5 MB en bytes)
                console.log(fileSize);
                console.log(maxSize);
                if (fileSize > maxSize) {
                    Swal.fire({
                      icon: 'warning',
                      title: 'El archivo supera el tamaño permitido de 1 MB.',
                      showConfirmButton: true,
                      timer: 5000
                    });
                    inputFile.value = '';
